...
{
    /// <inheritdoc />
    public partial class InitialUUIDMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostalCode_Code = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompartmentType = table.Column<int>(type: "integer", nullable: false),
                    IsReadyForOrders = table.Column<bool>(type: "boolean", nullable: false),
                    IsFullyLoaded = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Batches_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Batches_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryProofImageBase64 = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BatchOrders_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BatchOrders_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingStatuses_Shippings_ShippingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Batches_DriverId",
                table: "Batches",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_Batches_VehicleId",
                table: "Batches",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchOrders_BatchId",
                table: "BatchOrders",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchOrders_OrderId",
                table: "BatchOrders",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingStatuses_ShippingId",
